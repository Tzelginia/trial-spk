...
@section('content')
    ...
    <div>
        @if (auth()->user()->semester == null && auth()->user()->IPK == null)
            <section class="fs-5 intro">
                <div class="p-3 px-5">
                    <h3>
                        Intro
                    </h3>
                    <div class="px-5">
                        <form action="/dashboard/profile" method="post">
                            ...
                            <div class="mb-5">
                                ...
                                <input type="number" name="semester" class="form-control" id="exampleFormControlInput1"
                                    placeholder="5" max="8">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Berapa IPK mu saat ini</label>
                                <input type="number" name="ipk" class="form-control" id="exampleFormControlInput1"
                                    placeholder="3.75" step="any" max="4">
                            </div>
        ...
        @else
            @if (auth()->user()->semester <= 2)
                <section class="fs-5 intro">
                    <div class="p-3 px-5">
                        <h3>
                            Maaf Kamu hanya bisa mengikuti program belajar reguler
                        </h3>
                    </div>
                </section>
            @else
                <form action="/dashboard/alternatives" method="post">
                    ...
                    <section class="fs-5 general">
                        <div class="p-3 px-5">
                            ...
                            <div class="px-5">
                                <div class="mb-5">
                                    <label for="exampleFormControlInput1" class="form-label">Seberapa baik Anda dalam
                                        mengatur
                                        waktu
                                        dan
                                        memotivasi diri sendiri untuk menyelesaikan tugas tanpa pengawasan langsung?</label>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="criteria_Value[0]"
                                            id="generalop1" value="option1">
                                ...
                                <div class="mb-5">
                                    <label for="exampleFormControlInput1" class="form-label">Seberapa siap anda melakukan
                                        program
                                        secara
                                        tatap muka?</label>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="first_kesiapan" id="generalop1"
                                            value="1">
                                        <label class="form-check-label" for="generalop1">
                                            Sangat Tidak Siap
                                        </label>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="first_kesiapan" id="generalop2"
                                            value="2">
                                        <label class="form-check-label" for="generalop2">
                                            Tidak Siap
                                        </label>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="first_kesiapan"
                                            id="generalop3" value="3">
                                        <label class="form-check-label" for="generalop3">
                                            Netral
                                        </label>
                                    </div>
                                ...
                                <div class="mb-5">
                                    <label for="exampleFormControlInput1" class="form-label">seberapa siapkah anda
                                        memenuhi
                                        persyaratan berkas seperti logbook harian, laporan dan logbook bulanan dalam
                                        pelaksanaan
                                        program
                                        kuliah?</label>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="second_kesiapan"
                                            id="second_kesiapan1" value="1">
                                        <label class="form-check-label" for="second_kesiapan1">
                                            Sangat Tidak Siap
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="second_kesiapan"
                                            id="second_kesiapan2" value="2">
                                        <label class="form-check-label" for="second_kesiapan2">
                                            Tidak Siap
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="second_kesiapan"
                                            id="second_kesiapan3" value="3">
                                        <label class="form-check-label" for="second_kesiapan3">
                                            Netral
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="second_kesiapan"
                                            id="second_kesiapan4" value="4">
                                        <label class="form-check-label" for="second_kesiapan4">
                                            Siap
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="second_kesiapan"
                                            id="second_kesiapan5" value="5">
                                        <label class="form-check-label" for="second_kesiapan5">
                                            Sangat Siap
                                        </label>
                                    </div>
                                ...
                                <div class="mb-5">
                                    <label for="exampleFormControlInput1" class="form-label">
                                        Seberapa siap anda dalam mematuhi
                                        peraturan yang telah ditetapkan pada tiap program, untuk menjaga nama baik diri
                                        sendiri
                                        dan
                                        Polinema?
                                    </label>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="third_kesiapan"
                                            id="third_kesiapan1" value="1">
                                        <label class="form-check-label" for="third_kesiapan1">
                                            Sangat Tidak Siap
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="third_kesiapan"
                                            id="third_kesiapan2" value="2">
                                        <label class="form-check-label" for="third_kesiapan2">
                                            Tidak Siap
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="third_kesiapan"
                                            id="third_kesiapan3" value="3">
                                        <label class="form-check-label" for="third_kesiapan3">
                                            Netral
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="third_kesiapan"
                                            id="third_kesiapan4" value="4">
                                        <label class="form-check-label" for="third_kesiapan4">
                                            Siap
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="third_kesiapan"
                                            id="third_kesiapan5" value="5">
                                        <label class="form-check-label" for="third_kesiapan5">
                                            Sangat Siap
                                        </label>
                                    </div>
                    ...
                    <section class="fs-5 msib">
                        <div class="p-3 px-5">
                            ...
                            <div class="px-5">
                                <div class="mb-5">
                                    <label for="exampleFormControlInput1" class="form-label">Seberapa besar minat Anda
                                        terhadap
                                ...
                                <div class="mb-5">
                                    <label for="exampleFormControlInput1" class="form-label">seberapa yakin anda dengan
                                        kemampuan
                                        anda
                        ...
                        <div class="p-3 px-5">
                            ...
                            <div class="px-5">
                                <div class="mb-5">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="firstiisma"
                                            id="firstiisma1" value="1">
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="secondiisma"
                                            id="secondiisma1" value="1">
                        ...
                        <div class="p-3 px-5">
                            ...
                            <div class="px-5">
                                <div class="mb-5">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="firstreguler"
                                            id="firstreguler1" value="1">
                    ...
                    <section class="fs-5 exchange">
                        <div class="p-3 px-5">
                            ...
                            <div class="px-5">
                                ...
                                <div class="mb-5">
                                    <label for="exampleFormControlInput1" class="form-label">
                                        Seberapa yakin anda dengan kemampuan anda untuk bersaing dengan mahasiswa di kampus
                                        tujuan?
                                    </label>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="secondexc" id="secondexc1"
                                            value="1">
                                        <label class="form-check-label" for="secondexc1">
                                            Sangat Tidak Yakin
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="secondexc" id="secondexc2"
                                            value="2">
                                        <label class="form-check-label" for="secondexc2">
                                            Tidak Yakin
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="secondexc" id="secondexc3"
                                            value="3">
                                        <label class="form-check-label" for="secondexc3">
                                            Netral
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="secondexc" id="secondexc4"
                                            value="4">
                                        <label class="form-check-label" for="secondexc4">
                                            Yakin
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="secondexc" id="secondexc5"
                                            value="5">
                                        <label class="form-check-label" for="secondexc5">
                                            Sangat Yakin
                                        </label>
                                    </div>
