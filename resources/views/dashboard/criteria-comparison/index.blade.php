...
@section('content')
    ...
    <div class="p-5">
        <form action="/dashboard/criteria-comparisons" method="POST">
            @csrf
            <h5>Apakah biaya menjadi pertimbangan dan berpengaruh terhadap pilihanmu?</h5>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="decision" id="decision" value="yes">
                <label class="form-check-label" for="decision">
                    Iya
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="decision" id="decision" value="no">
                <label class="form-check-label" for="decision">
                    Tidak
                </label>
            </div>
                    ...
                    @foreach ($comparisons as $comparison)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <form action="/dashboard/criteria-comparisons/{{ $comparison->id }}" method="POST"
                                    class="d-inline">
                                    @method('delete')
                                    @csrf
